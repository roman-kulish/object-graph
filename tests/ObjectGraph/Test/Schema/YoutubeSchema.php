...
use ObjectGraph\Test\GraphNode\Youtube;
use ObjectGraph\Test\Schema\Youtube\ItemSchema;
use ObjectGraph\Test\Schema\Youtube\PageInfoSchema;
...
class YoutubeSchema extends Schema
{
    ...
    protected function build(SchemaBuilder $schema)
    {
        ...
        $schema->addField('nextPageToken');
        $schema->addField('regionCode');
        $schema->addField('pageInfo')->asGraphNode(PageInfoSchema::class);
        $schema->addField('items')->asGraphNodeArray(ItemSchema::class);
    }
}
